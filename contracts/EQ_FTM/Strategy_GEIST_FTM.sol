...
contract Strategy_GEIST_FTM {
    // This strategy is for FTM network. GEIST - wFTM pair. RewardToken = "GEIST"
    ...
    // tokens that comes from farm as additional rewards send to owner as fee
    address private gfUSDT = 0x940F41F0ec9ba1A34CF001cc03347ac092F5F6B5;
    address private gUSDC = 0xe578C856933D8e1082740bf7661e379Aa2A30b26;
    address private gFTM = 0x39B3bd37208CBaDE74D0fcBDBb12D606295b430a;
    address private gETH = 0x25c130B2624CF12A4Ea30143eF50c5D68cEFA22f;
    address private gDAI = 0x07E6332dD090D287d3489245038daF987955DCFB;
    ...
    address public constant stakingContract = 0x49c93a95dbcc9A6A4D8f77E59c038ce5020e82f8;
    // ------------>        END          <--------------
    ...
    function withdrawUSDTFee(address _owner) public onlyVault {
        ...
        _transfer(gFTM, _owner, getBalanceOfToken(gFTM));
        _transfer(gfUSDT, _owner, getBalanceOfToken(gfUSDT));
        _transfer(gETH, _owner, getBalanceOfToken(gETH));
        _transfer(gDAI, _owner, getBalanceOfToken(gDAI));
        _transfer(gUSDC, _owner, getBalanceOfToken(gUSDC));
    }
