...
contract Strategy_YEL_FTM {
    // This strategy is for FTM network. YEL - FTM pair. RewardToken = "Boo"
    ...
    uint256 private totalRewardsYEL;
    ...
    address public token1; // yel
    address public vault;

    // ------------> Important constants <--------------
    uint256 public constant pid = 43;
    bool public constant hasPid = true;
    address public router = 0xF491e7B69E4244ad4002BC14e878a34207E38c29;
    address public constant lpToken = 0x8BFf7b8B6a14e576a3634d6c0466A19A6E9b170a;
    ...
    function getBalanceOfToken(address _token) public view returns (uint256) {
        if(_token == YELtoken) {
            return IERC20(_token).balanceOf(address(this)) - totalRewardsYEL;
        }
        if(_token == WETH) {
